...
from isegm.model.ifss_hrnet_model import HRNetModel
...
def init_model(cfg):
    ...
    model.support_net.load_pretrained_weights(cfg.IMAGENET_PRETRAINED_MODELS.HRNETV2_W18)
...
def train(model, cfg, model_cfg):
    ...
    trainer = iFSSTrainer(model, cfg, model_cfg, loss_cfg,
                        trainset, valset,
                        optimizer='adam',
